                        ...
                        <ul class="list-group list-group-flush text-center">
                            <li class="list-group-item">
                                <div class="panel-body" style="margin-top: -10px; margin-bottom: -10px;">
                                    <div class="col-xs-12 col-md-12">
                                        <label for="nama">Jumlah Komentar : {{$komentars2}}</label>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                                <div class="panel-body" style="margin-top: -10px; margin-bottom: -10px;">
                                    ...
                                    <div class="col-xs-4 col-md-4">
                                        <label for="nama">Isi Komentar</label>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item">
                                <div class="panel-body" style="margin-top: -20px; margin-bottom: -20px;">
                                    <div class="col-xs-4 col-md-4">
                                        <label for="nama">{{$komentar->namauser}}</label>
                                    </div>
                                    <div class="col-xs-4 col-md-4">
                                        <label for="nama">{{$komentar->namamateri}}</label>
                                    </div>
                                    <div class="col-xs-4 col-md-4">
                                        <label for="nama">{{$komentar->isikomentar}}</label>
                                    </div>
                                </div>
                            </li>
                            @endforeach
