                        ...
                        <ul class="list-group list-group-flush text-center">
                            <li class="list-group-item">
                                <div class="panel-body" style="margin-top: -10px; margin-bottom: -10px;">
                                    <div class="col-xs-12 col-md-12">
                                        <label for="nama">Jumlah Pengumuman : {{$pengumumans2}}</label>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item">
                            ...
                            <li class="list-group-item">
                                <div class="panel-body" style="margin-top: -20px; margin-bottom: -20px;">
                                    <div class="col-xs-4 col-md-4">
                                        <label for="nama">{{$pengumuman->namauser}}</label>
                                    </div>
                                    <div class="col-xs-4 col-md-4">
                                        <label for="nama">{{$pengumuman->namakelas}}</label>
                                    </div>
                                    <div class="col-xs-4 col-md-4">
